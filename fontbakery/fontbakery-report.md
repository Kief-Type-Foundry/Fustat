 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, syriac, tifinagh, coptic, math, old-permic, canadian-aboriginal, tai-le
 ...
 * U+060C ARABIC COMMA: try adding one of: thaana, syriac, yezidi, nko, hanifi-rohingya, arabic
 * U+0615 ARABIC SMALL HIGH TAH: try adding arabic
 * U+061B ARABIC SEMICOLON: try adding one of: thaana, syriac, yezidi, nko, hanifi-rohingya, arabic
 * U+061F ARABIC QUESTION MARK: try adding one of: thaana, syriac, yezidi, adlam, nko, hanifi-rohingya, arabic
 ...
 * U+0640 ARABIC TATWEEL: try adding one of: old-uyghur, mandaic, psalter-pahlavi, sogdian, syriac, manichaean, adlam, hanifi-rohingya, arabic
 ...
 * U+0660 ARABIC-INDIC DIGIT ZERO: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, hanifi-rohingya, arabic
 * U+0661 ARABIC-INDIC DIGIT ONE: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0662 ARABIC-INDIC DIGIT TWO: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0663 ARABIC-INDIC DIGIT THREE: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0664 ARABIC-INDIC DIGIT FOUR: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0665 ARABIC-INDIC DIGIT FIVE: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0666 ARABIC-INDIC DIGIT SIX: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0667 ARABIC-INDIC DIGIT SEVEN: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 * U+0668 ARABIC-INDIC DIGIT EIGHT: try adding one of: thaana, syriac, yezidi, indic-siyaq-numbers, arabic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: myanmar, syloti-nagri, mahajani, takri, tirhuta, lepcha, tagalog, adlam, buhid, oriya, limbu, bhaiksuki, kannada, osage, gurmukhi, tai-viet, brahmi, balinese, marchen, phags-pa, psalter-pahlavi, hebrew, siddham, tifinagh, bassa-vah, duployan, old-permic, tagbanwa, masaram-gondi, zanabazar-square, miao, caucasian-albanian, kaithi, mandaic, kayah-li, chakma, tamil, meetei-mayek, khudawadi, manichaean, pahawh-hmong, telugu, saurashtra, buginese, khmer, sharada, canadian-aboriginal, bengali, mongolian, ahom, newa, rejang, grantha, sundanese, nko, javanese, batak, tibetan, sinhala, kharoshthi, thai, armenian, dogra, tai-tham, wancho, devanagari, malayalam, soyombo, coptic, tai-le, hanunoo, cham, symbols, khojki, music, syriac, lao, new-tai-lue, gunjala-gondi, math, mende-kikakui, warang-citi, hanifi-rohingya, modi, sogdian, thaana, yi, gujarati, elbasan
...
Your font does *not* cover the following languages that require the soft-dotted feature: Ebira (Latn, 2,200,000 speakers), Lugbara (Latn, 2,200,000 speakers), Zapotec (Latn, 490,000 speakers), Mfumte (Latn, 79,000 speakers), Dan (Latn, 1,099,244 speakers), Ma’di (Latn, 584,000 speakers), Yala (Latn, 200,000 speakers), Koonzime (Latn, 40,000 speakers), Bafut (Latn, 158,146 speakers), Basaa (Latn, 332,940 speakers), Ekpeye (Latn, 226,000 speakers), Dii (Latn, 71,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Southern Kisi (Latn, 360,000 speakers), Nzakara (Latn, 50,000 speakers), Navajo (Latn, 166,319 speakers), Belarusian (Cyrl, 10,064,517 speakers), Nateni (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ejagham (Latn, 120,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mundani (Latn, 34,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Kom (Latn, 360,685 speakers), Avokaya (Latn, 100,000 speakers), Fur (Latn, 1,230,163 speakers), Sar (Latn, 500,000 speakers), Aghem (Latn, 38,843 speakers), South Central Banda (Latn, 244,000 speakers), Igbo (Latn, 27,823,640 speakers), Cicipu (Latn, 44,000 speakers), Mango (Latn, 77,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers). [code: soft-dotted]
