 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, syriac, old-permic, tai-le, math, tifinagh, malayalam, coptic
 ...
 * U+060C ARABIC COMMA: try adding one of: syriac, hanifi-rohingya, yezidi, nko, thaana, arabic
 * U+0615 ARABIC SMALL HIGH TAH: try adding arabic
 * U+061B ARABIC SEMICOLON: try adding one of: syriac, hanifi-rohingya, yezidi, nko, thaana, arabic
 * U+061F ARABIC QUESTION MARK: try adding one of: syriac, hanifi-rohingya, yezidi, adlam, nko, thaana, arabic
 ...
 * U+0640 ARABIC TATWEEL: try adding one of: syriac, hanifi-rohingya, adlam, psalter-pahlavi, mandaic, sogdian, manichaean, arabic, old-uyghur
 ...
 * U+0660 ARABIC-INDIC DIGIT ZERO: try adding one of: syriac, indic-siyaq-numbers, hanifi-rohingya, yezidi, thaana, arabic
 * U+0661 ARABIC-INDIC DIGIT ONE: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0662 ARABIC-INDIC DIGIT TWO: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0663 ARABIC-INDIC DIGIT THREE: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0664 ARABIC-INDIC DIGIT FOUR: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0665 ARABIC-INDIC DIGIT FIVE: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0666 ARABIC-INDIC DIGIT SIX: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0667 ARABIC-INDIC DIGIT SEVEN: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0668 ARABIC-INDIC DIGIT EIGHT: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 * U+0669 ARABIC-INDIC DIGIT NINE: try adding one of: syriac, indic-siyaq-numbers, yezidi, thaana, arabic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: siddham, elbasan, music, marchen, khmer, newa, gunjala-gondi, zanabazar-square, gurmukhi, adlam, soyombo, kharoshthi, javanese, bengali, rejang, miao, pahawh-hmong, hebrew, hanunoo, saurashtra, caucasian-albanian, buginese, grantha, buhid, tibetan, gujarati, sundanese, tamil, tai-le, thai, psalter-pahlavi, mahajani, syloti-nagri, tifinagh, duployan, thaana, khudawadi, oriya, lepcha, yi, lao, new-tai-lue, malayalam, manichaean, symbols, tagbanwa, old-permic, mandaic, osage, brahmi, coptic, batak, chakma, mende-kikakui, nko, masaram-gondi, math, tai-viet, kaithi, tirhuta, sogdian, modi, bassa-vah, mongolian, canadian-aboriginal, telugu, wancho, takri, ahom, kayah-li, khojki, devanagari, myanmar, dogra, hanifi-rohingya, sinhala, kannada, tai-tham, bhaiksuki, cham, meetei-mayek, armenian, warang-citi, limbu, syriac, sharada, balinese, phags-pa, tagalog
...
Your font does *not* cover the following languages that require the soft-dotted feature: Ekpeye (Latn, 226,000 speakers), Southern Kisi (Latn, 360,000 speakers), Fur (Latn, 1,230,163 speakers), Nzakara (Latn, 50,000 speakers), Lugbara (Latn, 2,200,000 speakers), Bafut (Latn, 158,146 speakers), Koonzime (Latn, 40,000 speakers), Avokaya (Latn, 100,000 speakers), Zapotec (Latn, 490,000 speakers), Cicipu (Latn, 44,000 speakers), Nateni (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Ngbaka (Latn, 1,020,000 speakers), Mundani (Latn, 34,000 speakers), Makaa (Latn, 221,000 speakers), Kom (Latn, 360,685 speakers), Ma’di (Latn, 584,000 speakers), Navajo (Latn, 166,319 speakers), South Central Banda (Latn, 244,000 speakers), Gulay (Latn, 250,478 speakers), Dii (Latn, 71,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Yala (Latn, 200,000 speakers), Aghem (Latn, 38,843 speakers), Ebira (Latn, 2,200,000 speakers), Sar (Latn, 500,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Dan (Latn, 1,099,244 speakers), Basaa (Latn, 332,940 speakers), Ejagham (Latn, 120,000 speakers), Mango (Latn, 77,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mfumte (Latn, 79,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers). [code: soft-dotted]
