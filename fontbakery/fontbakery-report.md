...
<h2>Check results</h2><details><summary><b>[11] Fustat[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Shapes languages in all GF glyphsets. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyphsets/shape_languages">com.google.fonts/check/glyphsets/shape_languages</a>)</summary><div>
...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 518, but got 420 instead [code: descent]
...
* 🔥 **FAIL** The following glyph names do not comply with naming conventions: ae-ar, ain-ar, ain-ar.fina, ain-ar.init, ain-ar.medi, ainThreedots-ar, ainThreedotsbelow-ar, ainThreedotsdownabove-ar, ainTwodotshorizontalabove-ar, ainTwodotsverticalabove-ar, alef-ar, alef-ar.fina, alef-ar.short, alef-ar.short.fina, alefHamzaabove-ar, alefHamzabelow-ar, alefMadda-ar, alefMaksura-ar, alefMaksura-ar.fina, alefWasla-ar, alefabove-ar, alefbelow-ar, allah-ar, asterisk-ar, beeh-ar, beh-ar, behDotless-ar, behDotless-ar.fina, behDotless-ar.init, behDotless-ar.init.high, behDotless-ar.medi, behDotless-ar.medi.high, behDotless_hah-ar, behDotless_hah-ar.init, behThreedotsupabove-ar, behThreedotsupbelow-ar, behTwodotsbelowDotabove-ar, behVabove-ar, behVbelow-ar, behVinvertedbelow-ar, beheh-ar, behhamzaabove-ar, comma-ar, commaabove-ar, dad-ar, dadDotbelow-ar, dahal-ar, dal-ar, dal-ar.fina, dalDotbelow-ar, dalDotbelowTah-ar, dalFourdots-ar, dalRing-ar, dalThreedotsbelow-ar, dalThreedotsdown-ar, dalTwodotsverticalbelowTah-ar, dalVinvertedabove-ar, dalVinvertedbelow-ar, damma-ar, dammatan-ar, ddahal-ar, ddal-ar, decimalseparator-ar, decimalseparator-ar.tf, dotabove-ar, dotabove_tahabove-ar, dotabove_threedotsupabove-ar, dotabove_vabove-ar, dotabove_vinvertedabove-ar, dotbelow-ar, dotbelow-ar.alt, dotbelow_threedotsdownbelow-ar, dotcenter-ar, dotcenter_threedotsdownbelow-ar, doubleverticalbarbelow-ar, dul-ar, dyeh-ar, e-ar, eight-ar, eight-ar.tf, eight-persian, eight-persian.tf, fatha-ar, fathatan-ar, feh-ar, fehAfrican-ar, fehDotbelow-ar, fehDotbelowThreedotsabove-ar, fehDotless-ar, fehDotless-ar.fina, fehDotless-ar.init, fehDotless-ar.medi, fehDotmovedbelow-ar, fehThreedotsbelow-ar, fehThreedotsupbelow-ar, fehTwodotsbelow-ar, five-ar, five-ar.tf, five-persian, five-persian.tf, four-ar, four-ar.tf, four-persian, four-persian.locl, four-persian.locl.tf, four-persian.tf, fourdotsabove-ar, fourdotsbelow-ar, fourdotsbelow-ar.alt, fourdotscenter-ar, fullstop-ar, gaf-ar, gafInvertedstroke-ar, gafRing-ar, gafThreedots-ar, gafTwodotsbelow-ar, gafsarkashabove-ar, gafsarkashcenter-ar, ghain-ar, ghainDotbelow-ar, ghainThreedotsabove-ar, gueh-ar, hah-ar, hah-ar.fina, hah-ar.init, hah-ar.medi, hahHamzaabove-ar, hahTahTwodotshorizontalbelow-ar, hahTahabove-ar, hahTahbelow-ar, hahThreedotsabove-ar, hahThreedotsupbelow-ar, hahTwodotshorizontalabove-ar, hahTwodotsverticalabove-ar, hahVinvertedbelow-ar, hamza-ar, hamzaabove-ar, hamzabelow-ar, heh-ar, heh-ar.fina, heh-ar.init, heh-ar.medi, hehDoachashmee-ar, hehDoachashmee-ar.fina, hehDoachashmee-ar.medi, hehHamzaabove-ar, hehVinvertedabove-ar, hehgoal-ar, hehgoal-ar.fina, hehgoal-ar.medi, hehgoalHamzaabove-ar, hehgoalMark-ar, jeem-ar, jeemThreedotsabove-ar, jeemThreedotsbelow-ar, jeemTwodotsabove-ar, jeh-ar, kaf-ar, kaf-ar.init, kaf-ar.medi, kafDotabove-ar, kafDotbelow-ar, kafDotless-ar, kafDotless-ar.fina, kafRing-ar, kafThreedotsbelow-ar, kafTwodotshorizontalabove-ar, kafswash-ar, kafswash-ar.fina, kafswash-ar.init, kafswash-ar.medi, kashida-ar, kasra-ar, kasratan-ar, keheh-ar, keheh-ar.fina, kehehDotabove-ar, kehehThreedotsabove-ar, kehehThreedotsbelow-ar, kehehThreedotsupbelow-ar, kehehTwodotshorizontalabove-ar, kehehTwodotsverticalbelow-ar, kehehVabove-ar, khah-ar, kirghizyu-ar, lam-ar, lam-ar.fina, lam-ar.init, lam-ar.medi, lamDotabove-ar, lamTahabove-ar, lamThreedotsabove-ar, lamThreedotsbelow-ar, lamVabove-ar, lam_alef-ar, lam_alef-ar.fina, lam_alef-ar.fina.ss02, lam_hah-ar, lam_hah-ar.init, lellah-ar, madda-ar, meem-ar, meem-ar.fina, meem-ar.fina.ss01, meem-ar.init, meem-ar.medi, meem-ar.ss01, meemDotabove-ar, meemDotbelow-ar, meemThreedotsabove-ar, miniKeheh-ar, ng-ar, ngoeh-ar, nine-ar, nine-ar.tf, noon-ar, noonAfrican-ar, noonDotbelow-ar, noonRing-ar, noonTahabove-ar, noonThreedotsabove-ar, noonTwodotsbelow-ar, noonVabove-ar, noonVinvertedabove-ar, noonghunna-ar, noonghunna-ar.fina, nyeh-ar, oe-ar, one-ar, one-ar.tf, peh-ar, pehVabove-ar, peheh-ar, percent-ar, qaf-ar, qafAfrican-ar, qafDotabove-ar, qafDotbelow-ar, qafDotbelowNoDotAbove-ar, qafDotless-ar, qafDotless-ar.fina, qafThreedotsabove-ar, qafThreedotsaboveAfrican-ar, question-ar, reh-ar, reh-ar.fina, rehDotbelow-ar, rehDotbelowdotabove-ar, rehFourdots-ar, rehHamzaabove-ar, rehRing-ar, rehTwodots-ar, rehTwodotshorizontalaboveTahabove-ar, rehTwodotsverticalabove-ar, rehVbelow-ar, rehVinvertedabove-ar, rehv-ar, ring-ar, ring-ar.alt, ringbelow-ar, ringbelow-ar.alt, rnoon-ar, rreh-ar, sad-ar, sad-ar.fina, sad-ar.init, sad-ar.medi, sadThreedots-ar, sadThreedotsbelow-ar, sadTwodotsbelow-ar, seen-ar, seen-ar.fina, seen-ar.init, seen-ar.medi, seenDotbelowDotabove-ar, seenFourdotsabove-ar, seenTahTwodotshorizontalabove-ar, seenThreedotsbelow-ar, seenTwodotsverticalabove-ar, seenVinvertedabove-ar, semicolon-ar, seven-ar, seven-ar.tf, seven-persian, seven-persian.locl, seven-persian.locl.tf, seven-persian.tf, shadda-ar, sheen-ar, sheenDotbelow-ar, sheenThreedotsbelow-ar, sindhiampersand-ar, sindhipostpositionmen-ar, six-ar, six-ar.tf, six-persian, six-persian.tf, sukun-ar, tah-ar, tah-ar.fina, tah-ar.init, tah-ar.medi, tahDotbelow-ar, tahThreedots-ar, tahThreedotsbelow-ar, tahTwodotsabove-ar, tahabove-ar, tahabove_vabove-ar, tahbelow-ar, tahcenter-ar, tail-ar, tcheh-ar, tchehDotabove-ar, tchehVabove-ar, tcheheh-ar, teh-ar, tehMarbuta-ar, tehMarbutagoal-ar, tehRing-ar, tehThreedotsdown-ar, tehThreedotsupbelow-ar, tehVabove-ar, teheh-ar, thal-ar, theh-ar, thousandseparator-ar, thousandseparator-ar.tf, three-ar, three-ar.tf, threedotsdownabove-ar, threedotsdownbelow-ar, threedotsdownbelow-ar.alt, threedotsdowncenter-ar, threedotsupabove-ar, threedotsupbelow-ar, threedotsupbelow-ar.alt, threedotsupcenter-ar, tteh-ar, ttehVabove-ar, tteheh-ar, two-ar, two-ar.tf, two-persian, two-persian.tf, twodotshorizontalabove-ar, twodotshorizontalabove_tahabove-ar, twodotshorizontalabove_vabove-ar, twodotshorizontalbelow-ar, twodotshorizontalbelow-ar.alt, twodotshorizontalbelow_tahabove-ar, twodotshorizontalcenter-ar, twodotshorizontalcenter_tahabove-ar, twodotsverticalabove-ar, twodotsverticalbelow-ar, twodotsverticalbelow-ar.alt, twodotsverticalcenter-ar, u-ar, vabove-ar, vbelow-ar, vbelow-ar.alt, ve-ar, veh-ar, vinvertedabove-ar, vinvertedbelow-ar, vinvertedbelow-ar.alt, vinvertedcenter-ar, wasla-ar, waw-ar, waw-ar.fina, wawDotabove-ar, wawDotcenter-ar, wawHamzaabove-ar, wawTwodots-ar, wawring-ar, yeh-ar, yehFarsi-ar, yehHamzaabove-ar, yehKashmiri-ar, yehTail-ar, yehThreedotsaboveFarsi-ar, yehTwodotsaboveFarsi-ar, yehTwodotsbelowDotabove-ar, yehTwodotsbelowHamzaabove-ar, yehVabove-ar, yehVinvertedFarsi-ar, yehbarree-ar, yehbarree-ar.fina, yehbarree-ar.fina.narrow, yehbarreeHamzaabove-ar, yu-ar, zah-ar, zain-ar, zainVinvertedabove-ar, zero-ar, zero-ar.tf, zero-persian, zero-persian.locl, zero-persian.locl.tf and zero-persian.tf
...
* 🔥 **FAIL** The following glyphs could not be attached to the dotted circle glyph:
	...
	- strokeshortcomb [code: unattached-dotted-circle-marks]
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: math, tai-le, malayalam, coptic, tifinagh, old-permic, canadian-aboriginal, syriac
 ...
 * U+060C ARABIC COMMA: try adding one of: hanifi-rohingya, yezidi, nko, syriac, arabic, thaana
 * U+0615 ARABIC SMALL HIGH TAH: try adding arabic
 * U+061B ARABIC SEMICOLON: try adding one of: hanifi-rohingya, yezidi, nko, syriac, arabic, thaana
 * U+061F ARABIC QUESTION MARK: try adding one of: hanifi-rohingya, yezidi, nko, adlam, syriac, arabic, thaana
 ...
 * U+0640 ARABIC TATWEEL: try adding one of: manichaean, hanifi-rohingya, psalter-pahlavi, mandaic, adlam, sogdian, arabic, syriac, old-uyghur
 ...
 * U+0660 ARABIC-INDIC DIGIT ZERO: try adding one of: hanifi-rohingya, yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0661 ARABIC-INDIC DIGIT ONE: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 ...
 * U+0664 ARABIC-INDIC DIGIT FOUR: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0665 ARABIC-INDIC DIGIT FIVE: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0666 ARABIC-INDIC DIGIT SIX: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0667 ARABIC-INDIC DIGIT SEVEN: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0668 ARABIC-INDIC DIGIT EIGHT: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+0669 ARABIC-INDIC DIGIT NINE: try adding one of: yezidi, indic-siyaq-numbers, syriac, arabic, thaana
 * U+066A ARABIC PERCENT SIGN: try adding one of: syriac, thaana, nko, arabic
 ...
 * U+06AA ARABIC LETTER SWASH KAF: try adding arabic
 ...
 * U+06FA ARABIC LETTER SHEEN WITH DOT BELOW: try adding arabic
 * U+06FB ARABIC LETTER DAD WITH DOT BELOW: try adding arabic
 * U+06FC ARABIC LETTER GHAIN WITH DOT BELOW: try adding arabic
 * U+06FD ARABIC SIGN SINDHI AMPERSAND: try adding arabic
 * U+06FE ARABIC SIGN SINDHI POSTPOSITION MEN: try adding arabic
 ...
 * U+077E ARABIC LETTER SEEN WITH INVERTED V: try adding arabic
 * U+077F ARABIC LETTER KAF WITH TWO DOTS ABOVE: try adding arabic
 * U+0889 ARABIC LETTER NOON WITH INVERTED SMALL V: try adding arabic
 * U+088A ARABIC LETTER HAH WITH INVERTED SMALL V BELOW: try adding arabic
 * U+088B ARABIC LETTER TAH WITH DOT BELOW: try adding arabic
 * U+088C ARABIC LETTER TAH WITH THREE DOTS BELOW: try adding arabic
 * U+088D ARABIC LETTER KEHEH WITH TWO DOTS VERTICALLY BELOW: try adding arabic
 ...
 * U+08B5 ARABIC LETTER QAF WITH DOT BELOW AND NO DOTS ABOVE: try adding arabic
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: tibetan, kayah-li, rejang, khmer, kharoshthi, music, hanunoo, buginese, armenian, masaram-gondi, modi, batak, thaana, mahajani, pahawh-hmong, gujarati, lepcha, syloti-nagri, syriac, oriya, symbols, mongolian, hebrew, nko, myanmar, warang-citi, soyombo, bengali, bhaiksuki, buhid, caucasian-albanian, lao, coptic, devanagari, canadian-aboriginal, tifinagh, sinhala, miao, hanifi-rohingya, mende-kikakui, tirhuta, tai-le, kannada, meetei-mayek, saurashtra, mandaic, tamil, gurmukhi, marchen, new-tai-lue, brahmi, math, sundanese, wancho, malayalam, limbu, adlam, old-permic, osage, telugu, dogra, gunjala-gondi, tagalog, khudawadi, tai-viet, sogdian, thai, elbasan, psalter-pahlavi, sharada, bassa-vah, chakma, zanabazar-square, siddham, tai-tham, newa, duployan, takri, cham, phags-pa, tagbanwa, balinese, yi, grantha, kaithi, manichaean, ahom, javanese, khojki
...
* ⚠ **WARN** GPOS table lacks kerning info for the following non-ligated sequences:
	...
	- behDotless-ar.init + hah-ar.fina

	- hah-ar.fina + hah-ar.medi

	- lam-ar.init + lam-ar.medi

	- lam-ar.medi + shadda-ar

	- shadda-ar + alefabove-ar

	- alefabove-ar + heh-ar.fina

	- heh-ar.fina + lam-ar.medi

	- alefabove-ar + hehgoal-ar.fina

	- alef-ar + lam-ar.init

	- heh-ar.fina + lam-ar.init [code: lacks-kern-info]
...
* ⚠ **WARN** Interpolation issues were found in the font:
	...
	- Contour 0 start point differs in glyph 'hehVinvertedabove-ar' between location wght=400 and location wght=200

	- Contour 0 start point differs in glyph 'hehDoachashmee-ar' between location wght=400 and location wght=200

	- Contour 1 start point differs in glyph 'ringcomb' between location wght=200 and location wght=800

	- Contour 2 start point differs in glyph 'uring' between location wght=200 and location wght=800 [code: interpolation-issues]
</div></details><details><summary>⚠ <b>WARN:</b> Check math signs have the same width. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/math_signs_width">com.google.fonts/check/math_signs_width</a>)</summary><div>


* ⚠ **WARN** The most common width is 548 among a set of 10 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* gcommaaccent (U+0123): X=404.5,Y=-2.0 (should be at baseline 0?)

	* gafThreedots-ar (U+06B4): X=190.0,Y=699.0 (should be at cap-height 700?)

	* gafThreedots-ar (U+06B4): X=190.0,Y=699.0 (should be at cap-height 700?)

	* lamThreedotsbelow-ar (U+06B8): X=287.0,Y=-422.0 (should be at descender -420?)

	* five-persian (U+06F5): X=231.0,Y=702.0 (should be at cap-height 700?)

	* ttehVabove-ar (U+08C0): X=382.0,Y=701.0 (should be at cap-height 700?)

	* ttehVabove-ar (U+08C0): X=428.0,Y=701.0 (should be at cap-height 700?)

	* ttehVabove-ar (U+08C0): X=489.0,Y=701.0 (should be at cap-height 700?)

	* ttehVabove-ar (U+08C0): X=534.0,Y=701.0 (should be at cap-height 700?)
	...
	* onethird (U+2153): X=250.0,Y=702.0 (should be at cap-height 700?)

	* onethird (U+2153): X=177.0,Y=702.0 (should be at cap-height 700?)
	...
	* allah-ar (U+FDF2): X=593.0,Y=1001.0 (should be at ascender 1000?) [code: found-misalignments]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Mfumte (Latn, 79,000 speakers), Mango (Latn, 77,000 speakers), Dii (Latn, 71,000 speakers), Igbo (Latn, 27,823,640 speakers), Sar (Latn, 500,000 speakers), Basaa (Latn, 332,940 speakers), Nzakara (Latn, 50,000 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), South Central Banda (Latn, 244,000 speakers), Lugbara (Latn, 2,200,000 speakers), Zapotec (Latn, 490,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Southern Kisi (Latn, 360,000 speakers), Cicipu (Latn, 44,000 speakers), Ekpeye (Latn, 226,000 speakers), Ebira (Latn, 2,200,000 speakers), Makaa (Latn, 221,000 speakers), Ma’di (Latn, 584,000 speakers), Kom (Latn, 360,685 speakers), Koonzime (Latn, 40,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Fur (Latn, 1,230,163 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Gulay (Latn, 250,478 speakers), Dutch (Latn, 31,709,104 speakers), Dan (Latn, 1,099,244 speakers), Yala (Latn, 200,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Navajo (Latn, 166,319 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Bafut (Latn, 158,146 speakers), Bete-Bendi (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers), Avokaya (Latn, 100,000 speakers), Mundani (Latn, 34,000 speakers). [code: soft-dotted]
